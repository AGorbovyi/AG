...
public class HashTableSwing extends JFrame {
    ...
    private HashTableNew<String, String> hashTable = new HashTableNew<>(4);
...
//        hashTable.put("Madrid", "Spain");
    ...
    private class CanvasPanel extends JPanel {
        ...
        public void paint(Graphics g) {
            super.paint(g);
            HashTableNew<String, String>.Entry<String, String>[] table = hashTable.getTable();
            for (int i = 0; i < table.length; i++) {
                ...
                if (table[i] != null) {
                    ...
                    HashTableNew<String, String>.Entry<String, String> pointer = table[i];
